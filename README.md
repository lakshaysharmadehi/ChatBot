...
# Deploy
[![Deploy To Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/lakshaysharmadehi/ChatBot/blob/main)

# Normal Way
```python3
git clone https://github.com/lakshaysharmadehi/ChatBot
cd ChatBot
